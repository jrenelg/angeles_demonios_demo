$(function() {
	$.fn.countdown = function(options, callback) {
		...
		function countdown() {		
			...
			if (days == 1) { element.find(".time_Days").text(countdownLang_Day); } else { element.find(".time_Days").text(countdownLang_Days); }
			if (hours == 1) { element.find(".time_Hours").text(countdownLang_Hour); } else { element.find(".time_Hours").text(countdownLang_Hours); }
			if (minutes == 1) { element.find(".time_Minutes").text(countdownLang_Minute); } else { element.find(".time_Minutes").text(countdownLang_Minutes); }
			if (seconds == 1) { element.find(".time_Seconds").text(countdownLang_Second); } else { element.find(".time_Seconds").text(countdownLang_Seconds); }
